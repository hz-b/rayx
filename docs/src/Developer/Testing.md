...
- dvec **position** <- **normal**
- dvec **direction** <- **direction**
- double **energy** <- **lineDensity**
...
- dvec **position** <- (0,0,0)
- dvec **direction** <- **direction_expected**
- double **energy** <- 0
- double **weight** <- **weight_expected**
- others <- 0
...
- dvec **position** <- (0,0,0)
- dvec **direction** <- **direction_out**
- double **energy** <- 0
- double **weight** <- **weight_out**
- others <- 0
