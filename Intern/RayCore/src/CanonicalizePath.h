...
/// `relPath` is a path relative to the root of the RAY-X git repository (i.e. where .git lies).
/// canonicalizeRepositoryPath(relPath) yields an absolute path representing the same path.
/// Examples:
...
/// `relPath` is a path relative to the working directory of the user executing RAY-X at the point of execution.
/// canonicalizeUserPath(relPath) yields an absolute path representing the same path.
/// Examples:
