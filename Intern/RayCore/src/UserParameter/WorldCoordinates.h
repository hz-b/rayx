...
namespace RAYX
{
    class RAYX_API WorldCoordinates {
    ...
    public:
        ...
        WorldCoordinates(double alpha, double beta, double chi, double dist, std::vector<double> misalignment);
        WorldCoordinates();
        ~WorldCoordinates();
        ...
        glm::dvec4 calcPosition(WorldCoordinates prev, glm::dvec4 prev_pos, glm::dmat4x4 prev_or);
        glm::dvec4 calcPosition();
        glm::dmat4x4 calcOrientation(WorldCoordinates prev, glm::dvec4 prev_pos, glm::dmat4x4 prev_or);
