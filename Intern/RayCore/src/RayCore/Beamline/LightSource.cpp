...
namespace RAY
{
    LightSource::LightSource(int id, int numberOfRays, const char* name, int spreadType, double photonEnergy, double energySpread, std::vector<double> misalignment) : m_id(id), m_numberOfRays(numberOfRays), m_name(name),  m_energySpread(energySpread), m_photonEnergy(photonEnergy), m_misalignmentParams(misalignment){
