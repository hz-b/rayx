...
namespace RAY {
    class RAY_API Quadric {
        public:
            ...
            Quadric(const char* name, std::vector<double> inputPoints, std::vector<double> parameters, double alpha, double chi, double beta, double distanceToPreceedingElement, std::vector<double> misalignment, std::vector<double> tempMisalignment, Quadric* previous);
            Quadric(const char* name, Quadric* previous);
