...
namespace RAYX
{
    ...
    void Application::loadDummyBeamline()
    {
        ...
        std::shared_ptr<MatrixSource> matSourcePtr = std::make_shared<MatrixSource>(0, "matrix source", 20000, 0, 0.065, 0.04, 0, 0.001, 0.001, 100, 0, 1, 0, 0, std::vector<double>{ -3, -2, 0, 0 });
