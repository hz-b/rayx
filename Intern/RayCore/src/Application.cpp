...
namespace RAYX
{
    ...
    void Application::loadDummyBeamline()
    {
        ...
        std::shared_ptr<RAYX::PlaneMirror> pm = std::make_shared<RAYX::PlaneMirror>("pm_ell_ip_200mirrormis", 0, 50, 200, pos1, or1, std::vector<double>{0,0,0, 0,0,0,0});
        ...
        std::shared_ptr<RAYX::Ellipsoid> eb = std::make_shared<RAYX::Ellipsoid>("ellipsoid_ip_200mirrormis", 0, 50, 200, pos2, or2, 10, 10000, 1000, 0, 1, std::vector<double>{0,0,0, 0,0,0,0});
