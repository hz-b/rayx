...
void Application::loadDummyBeamline() {  // ! objects are created here
    ...
    // std::shared_ptr<RAYX::PlaneMirror> pm =
    ...
    //     "ellipsoid_ip_200mirrormis", Geometry::GeometricalShape::RECTANGLE,
    //     50, 200, pos2, or2, 10, 10000, 1000, 0, 1, std::vector<double>{0, 0,
    //     0, 0, 0, 0, 0});
    ...
    //         pos2, or2, designEnergy, orderOfDiffraction,
    ...
    m_Beamline->addOpticalElement(cy);
