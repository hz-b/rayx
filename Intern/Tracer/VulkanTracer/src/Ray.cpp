...
double Ray::getxDir() { return m_direction.x; }
double Ray::getyDir() { return m_direction.y; }

double Ray::getzDir() { return m_direction.z; }

double Ray::getxPos() { return m_position.x; }

double Ray::getyPos() { return m_position.y; }

double Ray::getzPos() { return m_position.z; }
double Ray::getEnergy() { return m_energy; }
double Ray::getWeight() { return m_weight; }
double Ray::getS0() { return m_stokes.s0; }
double Ray::getS1() { return m_stokes.s1; }
double Ray::getS2() { return m_stokes.s2; }
double Ray::getS3() { return m_stokes.s3; }
double Ray::getPathLength() { return m_pathLength; }
double Ray::getOrder() { return m_order; }
double Ray::getLastElement() { return m_lastElement; }
double Ray::getExtraParam() { return m_extraParam; }