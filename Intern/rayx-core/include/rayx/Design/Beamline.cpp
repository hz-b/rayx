...
std::exception nodeGenericException(std::string_view nodeName, std::optional<std::string_view> note = std::nullopt) {
...
int Node::objectId() const {
    ...
    throw nodeNotFoundException(name(), "this node does not have an associated object");
}
