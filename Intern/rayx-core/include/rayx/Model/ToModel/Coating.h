...
#include "rayx/Design/Coating.h"
#include "rayx/Model/Coating.h"

namespace rayx::detail {

template <>
struct ToModel<std::optional<Coating>> {
    static model::Coating apply(const std::optional<Coating>& optCoating) {
        if (!optCoating) {
