...
TEST_F(TestSuite, SphereGrating) { compareLastAgainstRayUI("SphereGrating", 1e-4, Sequential::Yes); } 
TEST_F(TestSuite, ToroidGrating) { compareLastAgainstRayUI("ToroidGrating", 1e-7, Sequential::Yes); } 
...
TEST_F(TestSuite, PlaneGratingDeviationAz) { compareLastAgainstRayUI("PlaneGratingDeviationAz", 1e-12, Sequential::Yes); }
