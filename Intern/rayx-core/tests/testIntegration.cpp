...
TEST_F(TestSuite, SphereGrating) { compareLastAgainstRayUI("SphereGrating", 1e-11, Sequential::Yes); } 
TEST_F(TestSuite, ToroidGrating) { compareLastAgainstRayUI("ToroidGrating", 1e-3, Sequential::Yes); } 
