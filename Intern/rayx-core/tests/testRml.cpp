...
//     glm::dmat4x4 orientationResult = b.m_DesignElements[0].m_element.m_inTrans;
//     glm::dvec4 positionResult = b.m_DesignElements[0].m_element.m_inTrans * glm::dvec4(0, 0, 0, 1);
...
TEST_F(TestSuite, groupTransformMisalignment) {
    ...
    glm::dvec4 positionCorrect = groupPos + groupOr * elementPos;
    glm::dmat4x4 orientationResult = b.m_DesignElements[0]->getOrientation();
    printDMat4(orientationResult);
    glm::dvec4 positionResult = b.m_DesignElements[0]->getPosition();
