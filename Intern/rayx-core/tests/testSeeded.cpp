...
// TODO: enable this test. this test was disabled, because the behaviour of mirrors was changes. in RAY-UI mirrors discarded rays in monte-carlo fashion. in RAYX rays are not discarded, but the intensity is adjusted per ray.
