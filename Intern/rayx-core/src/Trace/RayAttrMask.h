...
#define RAYX_X_MACRO_RAY_ATTR_ELECTRIC_FIELD_X    X(std::complex<double>, electric_field_x, ElectricFieldX)
#define RAYX_X_MACRO_RAY_ATTR_ELECTRIC_FIELD_Y    X(std::complex<double>, electric_field_y, ElectricFieldY)
#define RAYX_X_MACRO_RAY_ATTR_ELECTRIC_FIELD_Z    X(std::complex<double>, electric_field_z, ElectricFieldZ)
