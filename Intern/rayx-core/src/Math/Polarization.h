...
RAYX_FN_ACC
inline Stokes toStokes(const LocalElectricField& electricField) {
    (void)electricField;
    // TODO
    return {};
}
...
inline LocalElectricField toLocalElectricField(const Stokes& stokes) {
    (void)stokes;
    // check if degree of polarization == 1
    // TODO
    return {};
}
...
//
// RAYX_FN_ACC
// inline ElectricField toGlobalElectricFieldWithBaseConvention(const LocalElectricField localField, const glm::dvec3 forward) {
//     return rotationMatrixWithBaseConvention(forward) * ElectricField(localField, complex::Complex{0, 0});
// }
//
// RAYX_FN_ACC
// inline ElectricField toGlobalElectricField(const LocalElectricField localField, const glm::dvec3 forward, const glm::dvec3 up) {
//     return rotationMatrix(forward, up) * ElectricField(localField, complex::Complex{0, 0});
// }
//
// RAYX_FN_ACC
// inline ElectricField toGlobalElectricField(const LocalElectricField localField, const glm::dmat3 rotation) {
//     return rotation * ElectricField(localField, complex::Complex{0, 0});
// }
//
// RAYX_FN_ACC
// inline LocalElectricField toLocalElectricFieldWithBaseConvention(const ElectricField field, const glm::dvec3 forward) {
//     return glm::transpose(rotationMatrixWithBaseConvention(forward)) * field;
// }
//
// RAYX_FN_ACC
// inline LocalElectricField toLocalElectricField(const ElectricField field, const glm::dvec3 forward, const glm::dvec3 up) {
//     return glm::transpose(rotationMatrix(forward, up)) * field;
// }
//
// RAYX_FN_ACC
// inline LocalElectricField toLocalElectricField(const ElectricField field, const glm::dmat3 rotation) { return rotation * field; }
//
// /*
...
//
// RAYX_FN_ACC
// inline ElectricField toElectricFieldWithBaseConvention(const Stokes stokes, const glm::dvec3 forward) {
//     return toGlobalElectricFieldWithBaseConvention(toLocalElectricField(stokes), forward);
// }
//
// RAYX_FN_ACC
// inline ElectricField toElectricField(const Stokes stokes, const glm::dvec3 forward, const glm::dvec3 up) {
//     return toGlobalElectricField(toLocalElectricField(stokes), forward, up);
// }
//
// RAYX_FN_ACC
// inline ElectricField toElectricField(const Stokes stokes, const glm::dmat3 rotation) {
//     return rotation * ElectricField(toLocalElectricField(stokes), complex::Complex{0, 0});
// }
//
// RAYX_FN_ACC
// inline ElectricField toStokesWithBaseConvention(const ElectricField field, const glm::dvec3 forward) {
//     return toStokes(toLocalElectricFieldWithBaseConvention(field, forward));
// }
//
// RAYX_FN_ACC
// inline ElectricField toStokes(const ElectricField field, const glm::dvec3 forward, const glm::dvec3 up) {
//     return toStokes(toLocalElectricField(field, forward, up));
// }
//
// RAYX_FN_ACC
// inline ElectricField toStokes(const ElectricField field, const glm::dmat3 rotation) {
//     return toStokes(toLocalElectricField(field, rotation));
// }
