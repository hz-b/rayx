...
#define RAYX_X_MACRO_RAY_ATTR_FIELD_X     X(std::complex<double>, electric_field_x, ElectricFieldX, m_field.x     )
#define RAYX_X_MACRO_RAY_ATTR_FIELD_Y     X(std::complex<double>, electric_field_y, ElectricFieldY, m_field.y     )
#define RAYX_X_MACRO_RAY_ATTR_FIELD_Z     X(std::complex<double>, electric_field_z, ElectricFieldZ, m_field.z     )
