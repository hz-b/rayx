...
struct RAYX_API Ray {
    ...
    static Ray makeRayFrom(const glm::dvec3& origin, const glm::dvec3& direction, const glm::dvec4& stokes, const double energy,
                           const double eventType) {
        Ray ray;
        ray.m_position = origin;
        ray.m_direction = direction;
        ray.m_stokes = stokes;
        ray.m_energy = energy;
        ray.m_eventType = eventType;
    ...
    static Ray makeRayFrom(const glm::dvec3& origin, const glm::dvec3& direction, const glm::dvec4& stokes, const double energy,
                           const double eventType, const double pathLength, const double order, const double lastElement, const double extraParam) {
        Ray ray;
        ray.m_position = origin;
        ray.m_direction = direction;
        ray.m_stokes = stokes;
