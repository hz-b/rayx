...
BundleHistory Tracer::trace(const Beamline& beamline, Sequential sequential, uint64_t max_batch_size, uint32_t maxEvents) {
    return m_deviceTracer->trace(beamline, sequential, max_batch_size, maxEvents);
}
