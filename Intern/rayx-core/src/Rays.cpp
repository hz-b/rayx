...
int Rays::numPaths() const {
    auto path_id_copy = path_id;
    std::sort(path_id_copy.begin(), path_id_copy.end());
    return std::distance(path_id_copy.begin(), std::unique(path_id_copy.begin(), path_id_copy.end()));
}
