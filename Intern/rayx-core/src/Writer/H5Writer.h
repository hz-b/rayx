...
#ifndef NO_H5
RAYX_API Rays readH5Rays(const std::filesystem::path& filepath, const RayAttrFlag attr = RayAttrFlag::All);
...
RAYX_API void writeH5Rays(const std::filesystem::path& filepath, const std::vector<std::string>& source_names,
                          const std::vector<std::string>& element_names, const Rays& rays, const RayAttrFlag attr = RayAttrFlag::All);
