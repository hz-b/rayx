...
INLINE Surface serializeCubic(CubicSurface surface) {
    ...
    ser.m_cubic[0] = surface.m_b12;
    ser.m_cubic[1] = surface.m_b13;
    ser.m_cubic[2] = surface.m_b21;
    ser.m_cubic[3] = surface.m_b23;
...
INLINE CubicSurface deserializeCubic(Surface ser) {
    ...
    surface.m_b12 = ser.m_cubic[0];
    surface.m_b13 = ser.m_cubic[1];
    surface.m_b21 = ser.m_cubic[2];
