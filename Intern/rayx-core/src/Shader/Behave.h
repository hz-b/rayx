...
RAYX_FUNC_INLINE
Ray behaveSlit(Ray r, int id, [[maybe_unused]] Collision col, Inv<MemSpace>& inv) {
...
template <typename MemSpace>
RAYX_FUNC_INLINE
Ray behaveRZP(Ray r, int id, Collision col, Inv<MemSpace>& inv) {
...
template <typename MemSpace>
RAYX_FUNC_INLINE
Ray behaveGrating(Ray r, int id, Collision col, Inv<MemSpace>& inv) {
...
template <typename MemSpace>
RAYX_FUNC_INLINE
Ray behaveMirror(Ray r, int id, Collision col, Inv<MemSpace>& inv) {
...
template <typename MemSpace>
RAYX_FUNC_INLINE
Ray behaveImagePlane(Ray r, [[maybe_unused]] int id, [[maybe_unused]] Collision col, [[maybe_unused]] Inv<MemSpace>& inv) {
