...
// **********************************************************
RAYX_FN_ACC inline double getTheta(Ray r, glm::dvec3 normal, double offsetAngle) {
    double al = normal[0];
    double am = normal[1];
    double an = normal[2];
...
RAYX_FN_ACC inline double getBraggAngle(double energy, double dSpacing2) {
    int order = 1;
...
RAYX_FN_ACC inline double getAsymmetryFactor(double braggAngle, double alpha) {
...
RAYX_FN_ACC inline double getDiffractionPrefactor(double wavelength, double unitCellVolume) {
...
RAYX_FN_ACC inline complex::Complex computeEta(double theta, double bragg, double asymmetry, double structureFactorReFH, double structureFactorImFH,
...
RAYX_FN_ACC inline complex::Complex computeR(complex::Complex eta, double structureFactorReFH, double structureFactorImFH,
