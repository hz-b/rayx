...
RAYX_FUNC_INLINE
int RAYX_API getPalikEntryCount(int material, Inv<MemSpace>& inv) {
...
template <typename MemSpace>
RAYX_FUNC_INLINE
int RAYX_API getNffEntryCount(int material, Inv<MemSpace>& inv) {
    int m = material - 1;  // in [0, 91]
...
template <typename MemSpace>
RAYX_FUNC_INLINE
PalikEntry RAYX_API getPalikEntry(int index, int material, Inv<MemSpace>& inv) {
    int m = material - 1;  // in [0, 91]
...
template <typename MemSpace>
RAYX_FUNC_INLINE
NffEntry RAYX_API getNffEntry(int index, int material, Inv<MemSpace>& inv) {
    int m = material - 1;  // in [0, 91]
...
template <typename MemSpace>
RAYX_FUNC_INLINE
dvec2 RAYX_API getRefractiveIndex(double energy, int material, Inv<MemSpace>& inv) {
