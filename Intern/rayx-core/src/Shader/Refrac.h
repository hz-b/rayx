...
RAYX_FUNC_INLINE
Ray refrac2D(Ray r, dvec3 normal, double az, double ax, Inv<MemSpace>& inv) {
...
template <typename MemSpace>
RAYX_FUNC_INLINE
Ray refrac(Ray r, dvec3 normal, double linedensity, Inv<MemSpace>& inv) {
...
Ray RAYX_API refracPlane(Ray r, [[maybe_unused]] dvec3 normal,
                          double a, Inv<MemSpace>& inv) {  // TODO fix unused var
