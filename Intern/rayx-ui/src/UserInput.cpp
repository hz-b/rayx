...
// keyEventHandler
//------------------------------------------------------------------------------
void keyEventHandler(SDL_Window* window, const SDL_Event* event, const UserInputContext& context) {
...
//------------------------------------------------------------------------------
void mouseButtonEventHandler(SDL_Window* window, const SDL_Event* event, const UserInputContext& context) {
...
//------------------------------------------------------------------------------
void mouseMotionEventHandler(SDL_Window* window, const SDL_Event* event, const UserInputContext& context) {
