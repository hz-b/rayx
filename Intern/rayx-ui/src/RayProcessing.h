...
using RayFilterFunction = std::function<std::vector<size_t>(const BundleHistory&, size_t)>;
...
std::vector<size_t> kMeansFilter(const BundleHistory& bundleHist, size_t k);
