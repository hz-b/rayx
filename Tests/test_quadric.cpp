...
TEST(Quadric, testGlobalCoordinates) {
    ...
    std::shared_ptr<RAYX::PlaneMirror> p1a = std::make_shared<RAYX::PlaneMirror>("PlaneMirror1", RAYX::Geometry::GEOMETRICAL_SHAPE::RECTANGLE, 50, 200, pos, or1, sE); // {1,2,3,0.01,0.02,0.03}
    ...
    std::shared_ptr<RAYX::PlaneMirror> p2b = std::make_shared<RAYX::PlaneMirror>("PlaneMirror2", RAYX::Geometry::GEOMETRICAL_SHAPE::RECTANGLE, 50, 200, pos2, or2, sE); // {1,2,3,0.01,0.02,0.03}
    ...
    std::shared_ptr<RAYX::PlaneMirror> p3c = std::make_shared<RAYX::PlaneMirror>("PlaneMirror1", RAYX::Geometry::GEOMETRICAL_SHAPE::RECTANGLE, 50, 200, pos3, or3, sE); // {1,2,3,0.01,0.02,0.03}
    ...
    std::shared_ptr<RAYX::PlaneMirror> p4d = std::make_shared<RAYX::PlaneMirror>("PlaneMirror1", RAYX::Geometry::GEOMETRICAL_SHAPE::RECTANGLE, 50, 200, pos4, or4, sE); // {1,2,3,0.01,0.02,0.03}
