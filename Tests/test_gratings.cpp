...
TEST(planeGrating, testParams) {
    ...
    RAY::PlaneGrating p1 = RAY::PlaneGrating("planegrating", mount, width, height, deviation, normalIncidence, azimuthal, dist, designEnergyMounting, lineDensity, orderOfDiffraction, fixFocusConstantCFF, add_order, mis, vls, sE, NULL); 
    ...
    add_order = 1;
    RAY::PlaneGrating p2 = RAY::PlaneGrating("planegrating", mount, width, height, deviation, normalIncidence, azimuthal, dist, designEnergyMounting, lineDensity, orderOfDiffraction, fixFocusConstantCFF, add_order, mis, vls, sE, NULL); 
    ...
    RAY::PlaneGrating p3 = RAY::PlaneGrating("planegrating", mount, width, height, deviation, normalIncidence, azimuthal, dist, designEnergyMounting, lineDensity, orderOfDiffraction, fixFocusConstantCFF, add_order, mis, vls, sE, NULL); 
    ...
    RAY::PlaneGrating p4 = RAY::PlaneGrating("planegrating", mount, width, height, deviation, normalIncidence, azimuthal, dist, designEnergyMounting, lineDensity, orderOfDiffraction, fixFocusConstantCFF, add_order, mis, vls, sE, nullptr); 
...
TEST(SphereGrating, testParams) {
    ...
    RAY::SphereGrating s1 = RAY::SphereGrating("spheregrating", mount, width, height, deviation, incidence, azimuthal, distance, entranceArm, exitArm, designEnergy, linedensity, double(order), mis,vls,sE, NULL);
    ...
    mount = 1;
    RAY::SphereGrating s2 = RAY::SphereGrating("spheregrating", mount, width, height, deviation, incidence, azimuthal, distance, entranceArm, exitArm, designEnergy, linedensity, double(order), mis,vls, sE,NULL);
    /*double alpha = 1.4892226555787231;
    double beta = 1.4915379074397925;
    double chi = 2.1502456384570143;
    double theta = 4.6738270800745312;
