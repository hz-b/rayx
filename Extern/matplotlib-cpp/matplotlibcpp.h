...
template <typename Numeric>
void contour(const std::vector<::std::vector<Numeric>>& x, const std::vector<::std::vector<Numeric>>& y, const std::vector<::std::vector<Numeric>>& z,
...
template <typename Numeric>
bool arrow(Numeric x, Numeric y, Numeric end_x, Numeric end_y, const std::string& fc = "r", const std::string ec = "k", Numeric head_length = 0.25,
...
template <typename Numeric>
bool hist(const std::vector<Numeric>& y, std::string bins = "auto", std::string color = "b", double alpha = 1.0, bool cumulative = false,
          const std::map<std::string, std::string>& keywords = {}) {
    detail::_interpreter::get();
